...
public class DiskErrorsHandlerTest
{
    ...
    public void reset()
    {
        HandlerA.closed = false;
        HandlerA.initialized = false;
        HandlerB.closed = false;
        HandlerB.initialized = false;
        HandlerC.initialized = false;
        HandlerD.closed = false;
    }
    ...
    public void testFailures()
    {
                                                              ...
                                                              HandlerD.class.getName()))
        {
            ...
            // still handler c as handler d failed to init
            assertSame(HandlerC.class, get().getClass());
        }
    }
    ...
    private static abstract class DummyErrorHandler implements DiskErrorsHandler
    {
        ...
        @Override
        public boolean handleCommitError(String message, Throwable t) { return true; }
    }
}
