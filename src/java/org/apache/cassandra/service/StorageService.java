...
public class StorageService extends NotificationBroadcasterSupport implements IEndpointStateChangeSubscriber, StorageServiceMBean
{
    ...
    private void waitForNotEmptyLocalVersion(int delay) {
        ...
        while (totalTime < delay)
        {
            ...
            if (!Schema.emptyVersion.equals(version))
            {
    ...
    private List<SchemaAgreementMetadata> waitForSchemaAgreement(Set<MigrationTask.MigrationTaskCallback> callbacks)
    {
        ...
        return callbacks.stream()
                        .map(callback -> {
                            ...
                            SchemaAgreementMetadata metadata = new SchemaAgreementMetadata(tokenOwner);

                            EndpointState endpointState = Gossiper.instance.getEndpointStateForEndpoint(tokenOwner);
                            ...
                            metadata.schema = UUID.fromString(schema.value);
                            ...
                            logger.debug("Remote node {}, schema version: {}", tokenOwner.toString(), metadata.schema);
    ...
    private static final class SchemaAgreementMetadata
    {
        ...
        public SchemaAgreementMetadata(InetAddress remote)
        {
            this.remote = remote;
        }
