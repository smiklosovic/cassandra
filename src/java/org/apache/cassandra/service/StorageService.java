...
public class StorageService extends NotificationBroadcasterSupport implements IEndpointStateChangeSubscriber, StorageServiceMBean
{
    ...
    */
                               ...
                               String includedUsers, String excludedUsers) throws ConfigurationException, IllegalStateException
    {
        ...
        Preconditions.checkState(FBUtilities.isAuditLoggerClassExists(options.logger.class_name),
                                 "Unable to find AuditLogger class, it should be located in org.apache.cassandra.audit package: " + options.logger.class_name);
        ...
        logger.info("AuditLog is enabled with logger: [{}], included_keyspaces: [{}], excluded_keyspaces: [{}], " +
                    ...
                    + "excluded_users: [{}], archive_command: [{}]", options.logger, options.included_keyspaces, options.excluded_keyspaces,
                    options.included_categories, options.excluded_categories, options.included_users, options.excluded_users,
